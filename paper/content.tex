...
Automatically extracting such relationships from large corpora of unstructured text like 10-K filings significantly reduces the amount of data.
...
\textbf{Triples were labelled by experts according to their relevance as} \textit{irrelevant}, \textit{neutral}, \textit{relevant}, or \textit{highly relevant}.
...
This ranking reflects the relevance of a triple with respect to the imminence of business implications, given the contained knowledge of relationship between two companies.
