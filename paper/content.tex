...
When estimating the risk of a [future] transaction, analysts rely on large amounts of data from a variety of different sources, like newspapers, stock market trends and bank statements.
Finding relevant information in mostly unstructured data is a tedious task and considering all sources is virtually impossible.
